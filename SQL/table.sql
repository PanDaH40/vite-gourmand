...
/* CREATE TABLE utilisateur(
    utilisateur_id AUTO_INCREMENT PRIMARY KEY,
    email VARCHAR(50),
    password VARCHAR(50),
    prenom VARCHAR(50),
    telephone VARCHAR(50),
...
CREATE TABLE menu(
    menu_id AUTO_INCREMENT PRIMARY KEY,
    titre VARCHAR(50),
    nombre_personne_minimum INT,
    prix_par_personne DOUBLE,
    regime VARCHAR(50),
...
CREATE TABLE regime(
    regime_id AUTO_INCREMENT PRIMARY KEY,
    libelle VARCHAR(50)
);

CREATE TABLE theme(
    theme_id AUTO_INCREMENT PRIMARY KEY,
    libelle VARCHAR(50)
);

CREATE TABLE plat(
    plat_id AUTO_INCREMENT PRIMARY KEY,
    titre_plat VARCHAR(50),
    photo BLOB
);

CREATE TABLE ALLERGENE(
    allergene_id AUTO_INCREMENT PRIMARY KEY,
    libelle VARCHAR(50)
);

CREATE TABLE horaire(
    horaire_id AUTO_INCREMENT PRIMARY KEY,
    jour VARCHAR(50),
    heure_ouverture VARCHAR(50),
    heure_fermeture VARCHAR(50)
);
